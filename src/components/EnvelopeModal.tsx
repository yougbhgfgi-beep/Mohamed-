          ...
          <div className="glass-card rounded-3xl p-6 md:p-10 shadow-2xl animate-letter-slide relative max-h-[85vh] overflow-y-auto custom-scrollbar"
            ...
            <div className="space-y-6 text-right leading-relaxed"
              ...
              <p className="text-lg font-semibold text-pink-700">
                يا من سكنت قلبي وروحى، يا من جعلت حياتي أكثر جمالا وألوانًا، في هذا اليوم المميز، أريد أن أعبر لك عن مدى حبي بك .. "كل عام وأنتِ الحب الذي لا يتغير، القمر الذي ينير لي ليالي، يا أجمل هدية من الله، في كل مرة أنظر في عينيك، أجد نفسي أغرق في بحر من الحب والعشق، كل عام وأنتي بخير يا عمري"
              </p>
              
              <p className="text-base text-pink-600">
                وفي هذا اليوم الذي يحتفل فيه العالم بقدومكِ، أريد أن أخبركِ كم أنا محظوظ بوجودكِ في حياتي. أتذكر أول مره تحدثنا فيها، شعرت وكأنني أعرفكِ منذ الأزل. منذ ذلك الحين، أصبحتِ جزءًا لا يتجزأ من حياتي، شريكة أسرارى، وسندي في كل خطوة ..
              </p>
              ...
              <p className="text-base text-pink-600">
                أنتي أكثر من مجرد صديقة، أنتِ أختي، أنتي مراتي، انتي حبييتي ونصف روحي. أنتي دائمًا موجودة عندما أحتاجك، ودائمًا تدعميني وتشجعيني على تحقيق أحلامي.
              </p>
